...
-- ==========================================
-- Folding (Treesitter-based with fallback)
-- ==========================================
opt.foldenable = true       -- Enable folding
opt.foldmethod = "expr"     -- Use expression for folding
opt.foldexpr = "v:lua.vim.treesitter.foldexpr()" -- Use TreeSitter for folding when available
opt.foldlevel = 99          -- Open all folds by default
opt.foldlevelstart = 99     -- Start with all folds open
opt.foldminlines = 1        -- Minimum number of lines for a fold (default is 1)
opt.foldnestmax = 10        -- Maximum nesting of folds
opt.foldcolumn = "0"        -- Show fold column (0-9, or "auto")
opt.foldtext = ""           -- Use treesitter for fold text (empty = default folding, modern UI)
